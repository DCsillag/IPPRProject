...
#blur and edge image
blurred = cv.GaussianBlur(gray, (5, 5), 0)   #[NEW]]
edged = cv.Canny(blurred, 30, 200)

#intialise the text and color of input image, assuming that image is not low contrast [NEW]
text = "Not low contrast image"
color = (0, 255, 0)

#detects if low contrast [NEW]
